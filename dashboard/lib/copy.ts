...
export const UI_COPY = {
  ...
  realtime_chart: "Grafik Realtime",
  realtime_mode: "Realtime",
  realtime_connected: "Terhubung",
  realtime_disconnected: "Terputus",
  realtime_timeframe: "Jendela Waktu",
  realtime_1s: "1 Detik",
  realtime_30s: "30 Detik",
  realtime_1m: "1 Menit",
  realtime_5m: "5 Menit",
  realtime_no_data: "Menunggu data sensor...",
  realtime_points_count: "{count} titik data",
